...
**Owner**: Fidamen Validation System
...
- **Stage 2 (Manual/Automation)**: Restructure to strict Fidamen schema
...
Take the content JSON and restructure it into the full Fidamen schema.
...
2. **Map content to page_content**
   ```
   ChatGPT output             →  Fidamen page_content
