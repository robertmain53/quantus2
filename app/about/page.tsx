...
export const metadata: Metadata = {
  title: "About Cernarus",
  description:
    "Learn about Cernarus, the calculator platform built for professionals who need standards-aligned answers."
};
  ...
  return (
    <main className="container space-y-8 py-16">
      <header className="space-y-4">
        <h1 className="font-serif text-4xl font-semibold text-slate-900">About Cernarus<https://cernarus.com//h1>
        <p className="max-w-3xl text-lg text-slate-600">
          Cernarus exists to help technical teams deliver dependable calculators and conversion tools
      ...
      <section className="space-y-4 text-base text-slate-600">
        ...
        <p>
          ...
          modern edge-ready architecture, Cernarus empowers engineers, analysts, and product teams to
