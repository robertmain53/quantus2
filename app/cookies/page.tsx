...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description:
    "Details on how Fidamen uses cookies and local storage to enhance performance and personalization.",
  alternates: {
    canonical: "https://fidamen.com/cookies",
  },
};
...
export default function CookiesPage() {
  return (
    <main className="container space-y-6 py-8 sm:space-y-8 sm:py-12 lg:py-16">
      <Breadcrumb items={[{ label: "Cookie Policy", href: "/cookies" }]} />
