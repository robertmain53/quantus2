# Fidamen System Foundation Index
...
The Fidamen calculator platform has completed its **foundational architecture phase** with four critical documents and a proven two-stage workflow. This index provides a comprehensive reference to all core systems, their purposes, and how they work together.
...
- **Stage 2 (Human/Automation)**: Restructure into Fidamen schema
...
| README.md | Project overview | "How does Fidamen work end-to-end?" | Both |
