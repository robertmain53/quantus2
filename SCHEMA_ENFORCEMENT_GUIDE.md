...
The `generate-prompts.js` script now **embeds strict schema rules directly into the generated prompts**. This significantly reduces the risk of ChatGPT generating invalid JSON that doesn't match the Fidamen engine contract.
